...
contract("DeBridgeGate full mode (UUPS Proxy)",  function() {
  ...
  context("after UUPS upgrade V1 to V2", async function() {
    ...
    beforeEach(async function() {
      ...
      this.debridgeV2 = await upgrades.upgradeProxy(this.debridge.address, DebridgeV2Factory, { kind: 'uups' });
    });
