...
```
An addres to set as pauser for any deployed deBridgeToken
...
## setDeBridgeTokenPauser
```solidity
  function setDeBridgeTokenPauser(
            address _deBridgeTokenPauser
  ) external
```

Set pauser for any deployed deBridgeToken.

### Parameters:
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
|`_deBridgeTokenPauser` | address | Pauser address.
