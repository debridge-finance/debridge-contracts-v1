    ...
    IDeBridgeTokenDeployer
{
    ...
    /// @dev An addres to set as pauser for any deployed deBridgeToken
    address public deBridgeTokenPauser;
    ...
    function initialize(
        ...
        address _deBridgeTokenPauser,
        address _debridgeAddress
    ) public initializer {
        tokenImplementation = _tokenImplementation;
        deBridgeTokenAdmin = _deBridgeTokenAdmin;
        deBridgeTokenPauser = _deBridgeTokenPauser;
    ...
    /// @dev Set pauser for any deployed deBridgeToken.
    /// @param _deBridgeTokenPauser Pauser address.
    function setDeBridgeTokenPauser(address _deBridgeTokenPauser) external onlyAdmin {
        if (_deBridgeTokenPauser == address(0)) revert WrongArgument();
        deBridgeTokenPauser = _deBridgeTokenPauser;
    }
